...
export namespace workshop {
  ...
  export function queryItem(itemId: bigint): Promise<QueryItem>
  export function queryUser(page: number): Promise<Array<QueryItem>>
  export function queryUserTotalResultsNum(): Promise<number>
  /**
  ...
  export function subscribedItems(): Array<bigint>
}
